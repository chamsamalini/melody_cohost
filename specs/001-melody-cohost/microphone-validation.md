...
8. Click **Activate Melody** and confirm one short welcome response is generated.
...
- Transcript includes guest and Melody turns after activation.
...
- No Melody audio after activation: verify output device and browser autoplay/audio permissions.
